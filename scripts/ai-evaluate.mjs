...
import type { StarProject } from "@/lib/data/types";`;
  ...
  const body = `export const generatedStars: StarProject[] = ${JSON.stringify(clean, null, 2)};`;
...
interface LastSnapshot {
  ...
  const body = `export const lastSnapshot: LastSnapshot = ${JSON.stringify(snapshot, null, 2)};`;
